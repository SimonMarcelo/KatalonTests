...
public class LoginSteps {
	...
	public void login_with_valid_credentials(String username, String password) {
		//LoginTasks loginTasks = new LoginTasks()
		loginTasks.LoginWithValidCredentials(username, password)
	}

	@Then ("se visualiza que ingresó correctamente a la plataforma")
	public void correct_login_verification() {
		loginTasks.correctLoginVerification()
	}
}
