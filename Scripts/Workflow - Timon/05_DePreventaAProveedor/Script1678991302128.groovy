...
WebUI.click(findTestObject('Object Repository/Page_Cambiar Estado  TIMON/button_Proveedor'))

WebUI.setText(findTestObject('Object Repository/Page_Cambiar Estado  TIMON/input_Comentario_comentario'), 'Comentario a Proveedor')

WebUI.click(findTestObject('Object Repository/Page_Cambiar Estado  TIMON/div_Escriba un comentario                  _bb911f'))

WebUI.click(findTestObject('Object Repository/Page_Cambiar Estado  TIMON/input_Cerrar_ConfirmarProveedor'))
