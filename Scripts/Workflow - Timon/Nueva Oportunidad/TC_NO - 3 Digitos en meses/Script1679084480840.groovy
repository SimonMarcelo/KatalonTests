...
WebUI.setText(findTestObject('Object Repository/Page_Crear  TIMON/input_Duracin en Meses_DuracionMeses'), '100')
...
WebUI.verifyElementPresent(findTestObject('Page_Crear  TIMON/span_Ingrese un valor entre 0 y 99'), 3)
