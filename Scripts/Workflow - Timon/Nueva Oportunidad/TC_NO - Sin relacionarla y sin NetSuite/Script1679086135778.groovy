...
not_run: WebUI.setText(findTestObject('Object Repository/Page_Crear  TIMON/input_Oportunidad Relacionada_NumeroOportun_85649c'), 
    'ODM')

not_run: WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Crear  TIMON/div_ODM2023001 - Squad testing automatizado'), 
    3)

not_run: WebUI.click(findTestObject('Object Repository/Page_Crear  TIMON/div_ODM2023001 - Squad testing automatizado'))
...
WebUI.click(findTestObject('Object Repository/Page_Crear  TIMON/small'))

WebUI.setText(findTestObject('Object Repository/Page_Crear  TIMON/input_Datos Cliente_ClienteRedactado'), 'BANCO DE MEXICO')

not_run: WebUI.setText(findTestObject('Object Repository/Page_Crear  TIMON/input_Datos Cliente_DatosCliente'), 'banco hipotecario')

not_run: WebUI.waitForElementClickable(findTestObject('Page_Crear  TIMON/div_47 - BANCO HIPOTECARIO S.A'), 5)

not_run: WebUI.sendKeys(findTestObject('Object Repository/Page_Crear  TIMON/input_Datos Cliente_DatosCliente'), Keys.chord(
        Keys.ENTER))
...
not_run: WebUI.waitForElementClickable(findTestObject('Page_Listado de Oportunidades  TIMON/i_Simon, Marcelo_far fa-trash-alt red-text'), 
    3)

not_run: WebUI.click(findTestObject('Page_Listado de Oportunidades  TIMON/i_Simon, Marcelo_far fa-trash-alt red-text'))
