...
WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Listado de Oportunidades  TIMON/a_Crear'), 5)
...
WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Crear  TIMON/div_ODM2023001 - Squad testing automatizado'), 
    3)
...
def formatter = DateTimeFormatter.ofPattern("ddMMyyyy")
def ayer = LocalDate.now().minusDays(1).format(formatter)

WebUI.sendKeys(findTestObject('Object Repository/Page_Crear  TIMON/input_Fecha Lmite Presentacin_FechaLimitePr_3c87cb'), 
    ayer)

WebUI.click(findTestObject('Object Repository/Page_Crear  TIMON/input_Volver_BotonCrear'))

not_run: WebUI.navigateToUrl('https://desworkflow.ecosistemasinfo.com/Oportunidad/Create')

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Crear  TIMON/div_Cuidado La fecha lmite presentacin debe_34c5f3'), 
    0)
